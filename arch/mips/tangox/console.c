...
#define RD_UART_REG32(r)							\
	((tangox_uart_console_port() == 0) ? 					\
		gbus_read_reg32((((((tangox_chip_id() >> 16) & 0xfffe) == 0x8656) || (((tangox_chip_id() >> 16) & 0xfffe) == 0x8672) || (((tangox_chip_id() >> 16) & 0xfffe) == 0x8674)) ? \
...
#define WR_UART_REG32(r, v)								\
	((tangox_uart_console_port() == 0) ? 						\
		gbus_write_reg32((((((tangox_chip_id() >> 16) & 0xfffe) == 0x8656) || (((tangox_chip_id() >> 16) & 0xfffe) == 0x8672) || (((tangox_chip_id() >> 16) & 0xfffe) == 0x8674)) ? \
