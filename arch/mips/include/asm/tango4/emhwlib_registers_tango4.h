...
/******************************************************/
/*
 * ../emhwlib_hal/include/tango4/emhwlib_registers_tango4.h
 *
...
/**
  @file ../emhwlib_hal/include/tango4/emhwlib_registers_tango4.h
...
#ifndef __EMHWLIB_REGISTERS_TANGO4_H__
#define __EMHWLIB_REGISTERS_TANGO4_H__
...
#define LOG2_SYS_UART0_INT 1 /* width RMuint32 */
#define LOG2_CPU_UART1_INT 2 /* width RMuint32 */
#define LOG2_GPU_SGX_INT 3 /* width RMuint32 */
#define LOG2_GPU_IMGMEMBIF_INT 4 /* width RMuint32 */
#define LOG2_CPU_TIMER0_INT 5 /* width RMuint32 */
#define LOG2_CPU_TIMER1_INT 6 /* width RMuint32 */
#define LOG2_CPU_UNUSED7_INT 7 /* width RMuint32 */
#define LOG2_CPU_XPU_RESERVED2_INT 8 /* width RMuint32 */
#define LOG2_HOST_MBUS_W0_INT 9 /* width RMuint32 */
#define LOG2_HOST_MBUS_W1_INT 10 /* width RMuint32 */
#define LOG2_HOST_MBUS_R0_INT 11 /* width RMuint32 */
#define LOG2_HOST_MBUS_R1_INT 12 /* width RMuint32 */
#define LOG2_SYS_GPIO0_INT 13 /* width RMuint32 */
#define LOG2_SYS_GPIO1_INT 14 /* width RMuint32 */
#define LOG2_SYS_GPIO2_INT 15 /* width RMuint32 */
#define LOG2_SYS_GPIO3_INT 16 /* width RMuint32 */
#define LOG2_VP_W3_INT 17 /* width RMuint32 */
#define LOG2_BVO_DOUT0_EOF_INT 18 /* width RMuint32 */
#define LOG2_SYS_GPIO_FIP_INT 19 /* width RMuint32 */
#define LOG2_SYS_AOUT0_EOF_INT 20 /* width RMuint32 */
#define LOG2_SYS_GPIO_INFRARED_INT 21 /* width RMuint32 */
#define LOG2_SYS_GPIO_I2C_INT 22 /* width RMuint32 */
#define LOG2_VO_GFX_INT 23 /* width RMuint32 */
#define LOG2_VO_DMATOLBUS_INT 24 /* width RMuint32 */
#define LOG2_VO_VSYNC_AOUT0_INT 25 /* width RMuint32 */
#define LOG2_VO_VSYNC_AOUT1_INT 26 /* width RMuint32 */
#define LOG2_VO_VSYNC_DOUT0_INT 27 /* width RMuint32 */
#define LOG2_VI_DIGIN0_INT 28 /* width RMuint32 */
#define LOG2_VI_DIGIN0_VBI_INT 29 /* width RMuint32 */
#define LOG2_VO_W1_INT 30 /* width RMuint32 */
#define LOG2_VO_W2_INT 31 /* width RMuint32 */
#define LOG2_CPU_SMARTCARD0_INT 32 /* width RMuint32 */
#define LOG2_CPU_HDMI_INT 33 /* width RMuint32 */
#define LOG2_CPU_HDMI_I2C_INT 34 /* width RMuint32 */
#define LOG2_VO_W0_INT 35 /* width RMuint32 */
#define LOG2_VO_W3_INT 36 /* width RMuint32 */
#define LOG2_HOST_ETH0_PHY_INT 37 /* width RMuint32 */
#define LOG2_HOST_ETH0_MAC_INT 38 /* width RMuint32 */
#define LOG2_VP_SRC_PSO_DMA2LBUS_INT 39 /* width RMuint32 */
#define LOG2_HOST_USB20_INT 40 /* width RMuint32 */
#define LOG2_HOST_HSATA0_INT 41 /* width RMuint32 */
#define LOG2_HOST_HSATA0_DMA_INT 42 /* width RMuint32 */
#define LOG2_XPU_RESERVED3_INT 43 /* width RMuint32 */
#define LOG2_XPU_RESERVED4_INT 44 /* width RMuint32 */
#define LOG2_XPU_RESERVED5_INT 45 /* width RMuint32 */
#define LOG2_XPU_RESREVED6_INT 46 /* width RMuint32 */
#define LOG2_HOST_ETH_GPIO0_INT 47 /* width RMuint32 */
#define LOG2_HOST_ETH_GPIO1_INT 48 /* width RMuint32 */
#define LOG2_HOST_ETH_GPIO2_INT 49 /* width RMuint32 */
#define LOG2_HOST_ETH_GPIO3_INT 50 /* width RMuint32 */
#define LOG2_VO_W4_INT 51 /* width RMuint32 */
#define LOG2_CPU_SMARTCARD1_INT 52 /* width RMuint32 */
#define LOG2_SYS_HDMI_CEC_INT 53 /* width RMuint32 */
#define LOG2_HOST_HSATA1_INT 54 /* width RMuint32 */
#define LOG2_HOST_HSATA1_DMA_INT 55 /* width RMuint32 */
#define LOG2_HOST_ETH1_PHY_INT 56 /* width RMuint32 */
#define LOG2_HOST_ETH1_MAC_INT 57 /* width RMuint32 */
#define LOG2_HOST_MBUS_W2_INT 58 /* width RMuint32 */
#define LOG2_HOST_MBUS_R2_INT 59 /* width RMuint32 */
#define LOG2_HOST_SDIO0_INT 60 /* width RMuint32 */
#define LOG2_VP_OFMT3D_INT 61 /* width RMuint32 */
...
#endif /* __EMHWLIB_REGISTERS_TANGO4_H__ */

/* End of generated file ../emhwlib_hal/include/tango3/emhwlib_registers_tango4.h */
