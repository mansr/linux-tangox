...
#define MIPS_GIC_IRQ_BASE (MIPS_CPU_IRQ_BASE+MIPS_CPU_IRQ_COUNT)
#define MIPS_GIC_IRQ_COUNT 56		// assume maximum we used is 56

#if defined(CONFIG_TANGO4_89XX)
#define IRQ_COUNT               64  // 64 interrupt sources
#define IRQ_CONTROLLER_IRQ_BASE (MIPS_GIC_IRQ_BASE+MIPS_GIC_IRQ_COUNT)
#define FIQ_CONTROLLER_IRQ_BASE (IRQ_CONTROLLER_IRQ_BASE+IRQ_COUNT)
#define IIQ_CONTROLLER_IRQ_BASE (FIQ_CONTROLLER_IRQ_BASE+IRQ_COUNT)
#else
#error "Unsupported Tango4 chip."
#endif
