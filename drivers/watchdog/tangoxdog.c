/*
 *	TangoXDog 0.2 Hardware Watchdog Device for SMP864x/SMP865x/SMP867x/SMP868x
 *
...
static char banner[] __initdata = KERN_INFO PFX "Hardware Watchdog Timer for SMP864x/SMP865x/SMP867x/SMP868x 0.2 (def. timeout: %d sec)\n";
